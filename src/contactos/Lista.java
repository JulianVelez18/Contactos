...
public class Lista {
    ...
    public void modificar(Nodo nodo, String nombre, String telefono, String celular, String direccion, String correo) {
        if (nodo != null) {
            nodo.actualizar(nombre, telefono, celular, direccion, correo);
        }
    }

    public Lista buscar(String criterio) {
